...
function claimTokens($conn, $telegram_id) {
    $farmed_tokens = 9720; // 0.9 tokens per second * 10800 seconds (3 hours)
...
<head>
    ...
    <title>Crypto Farming System</title>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Crypto Farming System</h1>
        <div class="text-center">
            <button id="farmingButton" class="btn btn-primary btn-lg">Start Farming</button>
        </div>
    </div>
            ...
            function updateButtonStatus() {
                if (farmingStart && farmingEnd) {
                    ...
                    if (now < farmingEnd) {
                        ...
                        let tokensMined = ((now - farmingStart) * 0.9).toFixed(1);
